...
- **Encoding (M2-05c):** planner heuristic CJK regex anchors are ASCII-escaped (`\uXXXX`) in source; fixture/page data strings remain readable raw CJK. The CI encoding guard covers this package.
