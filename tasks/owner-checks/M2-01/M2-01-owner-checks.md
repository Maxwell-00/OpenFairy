...
- turn.final model_trace.denied_candidates visible: YES
...
- `ses_01KWNP0JGD3HXWD5GT5DA11GYT`
...
- Replay files were not regenerated during evidence cleanup; existing replay artifacts were sufficient for owner verification.
